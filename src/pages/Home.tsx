...
function Home() {
  return (
    <div className="flex m-navMargin items-center justify-center w-full h-screen text-center bg-light xl:text-start dark:bg-dark [transition:background-color_.3s,color_.3s]">
